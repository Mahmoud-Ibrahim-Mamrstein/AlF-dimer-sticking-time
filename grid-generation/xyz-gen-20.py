...
start=15 #(included)
stop=20  #(not included)
diff=stop-start #number of R values
previous_tot_config=int(36495360)
...
previous_no_files=int(792) #number of files already generated
no_files=int(Rr1r2_config/10) #number of files consisting of ten of those unique sets of combinations of R, r1 and r2 each each with their angles
